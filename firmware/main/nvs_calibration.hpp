...
struct CalibrationData {
    ...
    // Accelerometer X/Y zero-offset — a fixed error in the accel's own
    // electronics, constant regardless of orientation, separate from
    // gyro_bias_dps and face_a_offset_deg (which only corrects rotation).
    // Applied before face_a_offset_deg/atan2 in attitude_estimator.cpp.
